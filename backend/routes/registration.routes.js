...
router.post('/', verifyToken, async (req, res) => {
  ...
  try {
    ...
    // Insert registration (include opd_number and optional registration_number)
    const insertQuery = `INSERT INTO registrations (
        opd_number, camp_id, registration_number, first_name, middle_name, last_name, guardian_name, guardian_type_id,
